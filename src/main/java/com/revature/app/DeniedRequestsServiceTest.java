...
public class DeniedRequestsServiceTest {
	...
	public void testgetDecisionDate() {
		DeniedRequestsServices drs = new DeniedRequestServiceImpl();
		DeniedRequests de = new DeniedRequests();
		String test = drs.getDecisionDate("10/21/21");
		assertNotNull(test);
		assertEquals(de.getId(), 1);
	}
}
