...
public class EventTypesServiceTest {
	...
	@Test
	public void testaddpercentmods() {
		EventTypeServices evts = new EventTypesServicesImpl();
		EventTypes evt = new EventTypes();
		double test = evts.addPercentMods(100);
		assertNotNull(test);
		assertEquals(evt.getTypename(), "Training");
	}
}
