...
function submitQuestion(cur) {
    ...
    xhr2.open("POST", "http://localhost:7001/reimberequests", false);
    var obj = {};
...
function approveForm(cur) {
    ...
    if (true) {
        ...
        xhr2.open("POST", "http://localhost:7001/reimbrequests", false);
        var obj = {};
        obj["formId"] = curFormId;
        obj["approved"] = 1;
        var trash = JSON.stringify(obj)
...
function getApprovalForms() {
    ...
    xhr.open("GET", "http://localhost:7001/reimbrequests", true);
    xhr.send();
}
